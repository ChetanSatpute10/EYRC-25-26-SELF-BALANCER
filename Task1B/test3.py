...
def sysCall_init():
    ...
    integral_error = 0.0
    integral_limit = 0.01  # Anti-windup limit
...
def sysCall_sensing():
    ...
    # This helps maintain stability during orientation changes
    ...
    # UI-based yaw estimate with compensation
    ...
    # Update integral error with compensated pitch
...
def sysCall_cleanup():
    ...
    #################################
    global SIM, LEFT_JOINT, RIGHT_JOINT, ui_handle, SIMUI
    try:
        SIM.setJointTargetVelocity(LEFT_JOINT, 0)
        SIM.setJointTargetVelocity(RIGHT_JOINT, 0)
