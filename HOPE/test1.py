...
def euler_from_quaternion(quat):
    ...
    roll = atan2(sinr_cosp, cosr_cosp)  #import specified function from math py
...
def sysCall_init():
    ...
    self.SMOOTHING_COEFFICIENT = 0.025  # Configurable filter parameter
    ...
    print("Filter Smoothing Coefficient:", self.SMOOTHING_COEFFICIENT)
    ##################################


def sysCall_sensing():  #use classes for calling the function
...
def sysCall_actuation():
    ...
    # Apply exponential smoothing to gyroscope reading (pitch rate)
    ...
    # Apply exponential smoothing to wheel encoder reading
